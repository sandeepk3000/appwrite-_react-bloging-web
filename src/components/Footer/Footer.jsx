        ...
        <footer className="bg-white dark:bg-gray-900 mt-auto">
            <div className="mx-auto w-full max-w-screen-3xl">
                <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            ...
                            <li className="mb-4">
                                <Link to={"/articles/random"} href="#" className="hover:underline">Random</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            <li className="mb-4">
                                <Link to={"/articles/health"} href="#" className="hover:underline">
                ...
                <div className="bg-gray-100 dark:bg-gray-700 flex items-center justify-center py-4">
                    <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2024 <Link to={"/"}>Sandeep.dev™</Link>. All Rights Reserved.
                    </span>
